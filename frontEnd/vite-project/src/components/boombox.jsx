...
const MySpotifyPlayer = () => {
  ...
  const getOAuthToken = (callback) => {
    // Fetch access token from Spotify API here
    // Example:
    const accessToken =
      "Bearer BQDWXs4qo1jSu76ubhvwUGfCTzzR3AwEkVRk9zkiCqxmbenEaeLme-c-20inIPN38uXX2SyBgVFib2uyWpETc-AHbhP9R_uC5K6eMO7YdsEe3P-K6a4";
  ...
  return (
    <div>
      ...
      {/* Assuming you have a SpotifyPlayer component */}
      {/* Make sure to replace 'SpotifyPlayer' with the correct component */}
      {/* <SpotifyPlayer
        token=""
  ...
  return (
    <div id="background">
      ...
      >
        ...
        <path
          fill="#4407FD"
          d="M146 9a9 9 0 0 1 9-9h410a9 9 0 0 1 9 9v28H146V9Z"
        />
      </svg>
    </div>
  );
...
const Screen = ({ songName, artist, time }) => {
  return (
    <div id="screen">
      ...
      <h2 className="text" id="songName">
        {songName}
      </h2>
      <h2 className="text" id="artist">
        {artist}
      </h2>
      <h1 className="text" id="time">
        {time}
      </h1>
    </div>
  );
